...
public class PriorityQueue {
	...
	public void insert(int priority) {
		if (this.end < this.maxLength) {
			...
			this.time++;
			System.out.println("Inserted: " + newItem);
	...
	public void delete() {
		TimedPriority deleted = this.priorityQueue[0];
		...
		if (this.end > 0) {
			...
			this.time++;
			System.out.println("Deleted: " + deleted + " Current max age removed: " + this.maxAgeRemoved + " Which is "
					+ this.oldestTaken);
			System.out.println(this);
		} else {
	...
	public String toString() {
		String content = "Contains Root->leaf:";
